...
## Dashboard:
- The dashboard can be broken down into two parts: inputs and outputs
- Inputs
...
- Outputs
  ...
  - The dashboard looks best when Streamlit is on “wide mode” and the user may need to tinker with the spot price and implied volatility sliders to show the heatmap (this is a bug I need to fix)
